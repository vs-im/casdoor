 ...
 * console": the server is then only an identity provider for its regular users, so
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 p-6 text-center">
      ...
      <p className="max-w-xl text-muted-foreground">
        {i18next.t("organization:The console is disabled for the regular users of this organization")}
      </p>
