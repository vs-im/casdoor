...
function ManagementPage(props) {
  ...
  const navItems = Setting.isLocalAdminUser(props.account)
  ...
  const selectedLeafKey =
    "/" + (currentUri.split("/").filter(Boolean)[0] || "");

  const isDark = props.themeAlgorithm.includes("dark");
  const textColor = isDark ? "white" : "black";
  const siderLogo = (() => {
    if (!props.account?.organization) {
      return Setting.getLogo(props.themeAlgorithm);
    }
    let logo =
      props.account.organization.logo || Setting.getLogo(props.themeAlgorithm);
  ...
  function logout() {
    AuthBackend.logout().then((res) => {
      if (res.status === "ok") {
        ...
        Setting.showMessage(
          "error",
          `${i18next.t("general:Failed to log out")}: ${res.msg}`
        );
      }
    });
  }
  ...
  function renderWidgets() {
    ...
    if (!location.startsWith("/apps")) {
      widgets.push(
        <div className="select-box" onClick={redirectToApp}>
          <BackToAppIcon />
        </div>
      );
    }
      ...
      return (
        <React.Fragment>
          {Setting.isLocalAdminUser(props.account) &&
            ...
            >
              <span className="saas-hosting-btn">🚀 SaaS Hosting 🔥</span>
            </a>
          )}
          {Setting.isAdminUser(props.account) &&
            ...
            <OrganizationSelect
              ...
              style={{
                display: Setting.isMobile() ? "none" : "flex",
  ...
  function getMenuItems() {
    ...
    res.push(
      Setting.getItem(
        ...
        [
          ...
          Setting.getItem(
            <Link to="/keys">{i18next.t("general:Keys")}</Link>,
            "/keys"
          ),
        ]
      )
    ...
    res.push(
      Setting.getItem(
        <Link style={{color: textColor}} to="/sites">
          {i18next.t("general:LLM AI")}
        </Link>,
        "/gateway",
        <CheckCircleOutlined />,
        [
          Setting.getItem(
            <Link to="/agents">{i18next.t("general:Agents")}</Link>,
            "/agents"
          ),
          Setting.getItem(
            <Link to="/servers">{i18next.t("general:MCP Servers")}</Link>,
            "/servers"
          ),
          Setting.getItem(
          ...
          Setting.getItem(
            <Link to="/entries">{i18next.t("general:Entries")}</Link>,
            "/entries"
          ),
          Setting.getItem(
            <Link to="/sites">{i18next.t("general:Sites")}</Link>,
            "/sites"
          ),
          Setting.getItem(
            <Link to="/rules">{i18next.t("general:Rules")}</Link>,
            "/rules"
          ),
        ]
      )
    ...
    res.push(
      Setting.getItem(
        ...
        [
          ...
          Setting.getItem(
            <Link to="/coupons">{i18next.t("general:Coupons")}</Link>,
            "/coupons"
          ),
          Setting.getItem(
            <Link to="/cart">{i18next.t("general:Cart")}</Link>,
            "/cart"
          ),
          Setting.getItem(
            <Link to="/orders">{i18next.t("general:Orders")}</Link>,
            "/orders"
          ),
          Setting.getItem(
          ...
          Setting.getItem(
            <Link to="/transactions">{i18next.t("general:Transactions")}</Link>,
            "/transactions"
          ),
        ]
      )
      ...
      res.push(
        Setting.getItem(
          ...
          [
            ...
            Setting.getItem(
              <Link to="/forms">{i18next.t("general:Forms")}</Link>,
              "/forms"
            ),
            Setting.getItem(
            ...
            Setting.getItem(
              <Link to="/tickets">{i18next.t("general:Tickets")}</Link>,
              "/tickets"
            ),
            Setting.getItem(
              <a
    ...
    return (
      <Switch>
        <Route
          ...
          render={(props) =>
            account === null ? (
              ...
              <Dashboard account={account} {...props} />
            ) : null
          }
        />
        <Route
        ...
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <KeyListPage account={account} {...props} />
            )
          }
        />
        <Route
          exact
          path="/keys/:organizationName/:keyName"
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <KeyEditPage account={account} {...props} />
            )
          }
        />
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <AgentListPage account={account} {...props} />
            )
          }
        />
        <Route
          exact
          path="/agents/:organizationName/:agentName"
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <AgentEditPage account={account} {...props} />
            )
          }
        />
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <ServerListPage account={account} {...props} />
            )
          }
        />
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <ServerStorePage account={account} {...props} />
            )
          }
        />
        <Route
          exact
          path="/servers/:organizationName/:serverName"
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <ServerEditPage account={account} {...props} />
            )
          }
        />
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <EntryListPage account={account} {...props} />
            )
          }
        />
        <Route
          exact
          path="/entries/:organizationName/:entryName/transcript"
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <OpenClawSessionTranscriptPage account={account} {...props} />
            )
          }
        />
        <Route
          exact
          path="/entries/:organizationName/:entryName"
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <EntryEditPage account={account} {...props} />
            )
          }
        />
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <SiteListPage account={account} {...props} />
            )
          }
        />
        <Route
          exact
          path="/sites/:organizationName/:siteName"
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <SiteEditPage account={account} {...props} />
            )
          }
        />
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <RuleListPage account={account} {...props} />
            )
          }
        />
        <Route
          exact
          path="/rules/:organizationName/:ruleName"
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <RuleEditPage account={account} {...props} />
            )
          }
        />
        <Route
        ...
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <ProductStorePage account={account} {...props} />
            )
          }
        />
        <Route
        ...
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <CouponListPage account={account} {...props} />
            )
          }
        />
        <Route
          exact
          path="/coupons/:organizationName/:couponName"
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <CouponEditPage account={account} {...props} />
            )
          }
        />
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <CartListPage account={account} {...props} />
            )
          }
        />
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <OrderListPage account={account} {...props} />
            )
          }
        />
        <Route
          exact
          path="/orders/:organizationName/:orderName"
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <OrderEditPage account={account} {...props} />
            )
          }
        />
        <Route
          exact
          path="/orders/:organizationName/:orderName/pay"
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <OrderPayPage account={account} {...props} />
            )
          }
        />
        <Route
        ...
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <FormListPage account={account} {...props} />
            )
          }
        />
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <FormEditPage account={account} {...props} />
            )
          }
        />
        <Route
        ...
        <Route
          exact
          path="/syncers/:organizationName/:syncerName"
          render={(props) =>
            renderLoginIfNotLoggedIn(
        ...
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <WebhookEventListPage account={account} {...props} />
            )
          }
        />
        <Route
        ...
        <Route
          ...
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <TicketListPage account={account} {...props} />
            )
          }
        />
        <Route
          exact
          path="/tickets/:organizationName/:ticketName"
          render={(props) =>
            renderLoginIfNotLoggedIn(
              <TicketEditPage account={account} {...props} />
            )
          }
        />
        <Route
  ...
  const contentMarginLeft = showSider
    ? siderCollapsed
      ? siderCollapsedWidth
      : siderWidth
    : 0;
  ...
  const isLandingPage =
    props.account === null && (currentUri === "/" || currentUri === "");
          ...
          >
            <Link to="/">
              <img
                src={
                  siderCollapsed
                    ? organization?.favicon || siderLogo || props.logo
                    : (siderLogo ?? props.logo)
                }
                alt="logo"
                style={{
      ...
      >
        <Header
          style={{
            ...
            alignItems: Setting.isMobile() ? "center" : undefined,
            padding: "0",
            marginBottom: "4px",
            backgroundColor: isDark ? "black" : "white",
            color: textColor,
